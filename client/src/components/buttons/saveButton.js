const SaveButton = ({ active }) => {
    return(
        <button className="p-2 hover:bg-amber-600 hover:bg-opacity-10 [&:hover_path]:stroke-amber-600 transition rounded-full ">
            <svg className={`${active && 'fill-amber-600 [&_path]:stroke-amber-600'} w-5 h-5`} viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
