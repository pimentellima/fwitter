const CommentButton = ({ onClick, comments }) => {
    return(
        <button onClick={onClick} className="flex flex-row gap-2 p-2 hover:bg-blue-600 hover:bg-opacity-10 [&:hover_path]:stroke-blue-600 transition duration-100 rounded-full ">
