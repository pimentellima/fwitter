...
const SettingsLink = () => {
    ...
    return(
        <Link 
            to='/settings'
            className="group flex [&:hover_p]:bg-stone-700"
            >
            <p className={`font-[22px] gap-2 flex pl-4 pr-7 py-2 transition
                    ease-out duration-100 rounded-3xl group-hover:bg-stone-700
                    items-center
